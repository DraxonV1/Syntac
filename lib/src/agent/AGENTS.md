...
- Every attachment already owned by chat remains available to later tool calls and model context; missing model metadata must fall back to provider image capability.
